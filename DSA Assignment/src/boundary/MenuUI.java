...
public class MenuUI {
    ...
    public void displayTimeSlotInterviewMenu(String company) {
        ...
        System.out.println(
                VERTICAL_LINE + " > 11. Back to Previous Menu" + " ".repeat(dynamicWidth - 31) + VERTICAL_LINE);
    ...
    public void printSkillTableHeader() {
        System.out.println("\n+" + repeat(TABLE_HORIZONTAL, 18) + "+" + repeat(TABLE_HORIZONTAL, 15) + "+"
                + repeat(TABLE_HORIZONTAL, 15) + "+");
        System.out.println(TABLE_VERTICAL + " Skill Name       " + " " + TABLE_VERTICAL + " Category      " + " "
                + TABLE_VERTICAL + " Proficiency   " + " " + TABLE_VERTICAL);
