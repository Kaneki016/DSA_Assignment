...
public class CompanyManager {
    ...
    public void displayRemovedCompanies() {
        ...
        if (removedCompanies.isEmpty()) {
            inputUI.displayMessage("No companies have been removed.\n");
            return;
        }
        ...
        for (Company company : removedCompanies) {
            ...
            inputUI.displayMessage("   Removed On: " + company.getRemovedAt().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")));
            index++;
        }
    }
