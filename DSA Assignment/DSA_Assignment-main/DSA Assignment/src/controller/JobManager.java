...
public class JobManager {
    ...
    public void addJob() {
        ...
        while (true) {
            ...
            if (!location.trim().isEmpty()) break;
        ...
        DoublyLinkedListInterface<JobRequirements> globalRequirements = jrManager.getJobRequirementsList();
        ...
        while (addingRequirements) {
            ...
            if (globalRequirements.isEmpty()) {
                ...
                for (JobRequirements req : globalRequirements) {
                    inputUI.displayMessage(req.getJobRequirementId() + " - " + req.toString());
                }
            }
        ...
        while (editingRequirements) {
            ...
            if (choice.equalsIgnoreCase("x")) {
                ...
                while (continueAdding) {
                    ...
                    String cont = inputUI.getInput("Continue to add requirement? (Y/N): ");
    ...
    public void displayRemovedJobs() {
        ...
        // Print the removed jobs using menuUI (assuming you also have printRemovedJobs similar to printJobs)
